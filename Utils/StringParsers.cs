...
namespace AdventOfCode.Utils
{
    public static class StringParsers
    {
        ...
        public static KeyValuePair<string, string> SplitDelimitedStringIntoStringKeyValuePair(string stringToSplit, char delimiter)
        {
        ...
        public static KeyValuePair<string, int> SplitDelimitedStringIntoIntKeyValuePair(string stringToSplit, char delimiter, int fromBase = 10)
        {
            var keyValuePairList = stringToSplit.Trim().Split(delimiter, StringSplitOptions.TrimEntries | StringSplitOptions.RemoveEmptyEntries)
                .ToList();
        ...
        public static IDictionary<string, string> SplitDelimitedStringIntoStringDict(string stringToSplit, char keyValuePairDelimiter, char entryDelimiter = ' ')
        {
            ...
            {
                dictToReturn.Add(SplitDelimitedStringIntoStringKeyValuePair(keyValuePairString, keyValuePairDelimiter));
            }

            return dictToReturn;
        }

        public static IDictionary<string, int> SplitDelimitedStringIntoIntDict(string stringToSplit, char keyValuePairDelimiter, char entryDelimiter = ' ', int fromBase = 10)
        {
            IDictionary<string, int> dictToReturn = new Dictionary<string, int>();
            var splitString = SplitDelimitedStringIntoStringList(stringToSplit, entryDelimiter);
            foreach (var keyValuePairString in splitString)
            {
                dictToReturn.Add(SplitDelimitedStringIntoIntKeyValuePair(keyValuePairString, keyValuePairDelimiter));
            }
